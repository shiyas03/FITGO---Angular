...
export class BlogsComponent {
  ...
  constructor(private dialog: MatDialog, private store: Store<Blog[]>, private adminService: AdminAuthService) { }
  ...
  publishChange(id: string, approve: boolean) {
    this.adminService.publishBlog(id, approve).subscribe(res=>{
      if(res.success==true){
        this.fetchData()
      }
    })
